<template>
  <main class="gap-x-5 sm:gap-x-10 -m-5 sm:m-0">
    <!-- Mobile: Full-screen carousel first -->
    <div class="sm:hidden relative w-full h-screen z-0">
      <ProjectCarousel v-if="projects" :projects="projects" :autoplay-interval="5000" />
    </div>

    <!-- Mobile: Article text after carousel -->
    <div id="mobile-article-section" class="sm:hidden relative z-10 p-5 sm:p-0 min-h-screen flex flex-col gap-5 sm:gap-10">
        ...
        >
        <!-- Footer on mobile -->
        <Footer class="sm:hidden mt-auto pt-20" />
    </div>

    <!-- Desktop layout -->
    <div class="hidden sm:flex sm:flex-row sm:h-screen sm:overflow-hidden relative z-10">
      <!-- Left side: Text + Button + Footer (50%) -->
      <div class="flex flex-col justify-between sm:w-1/2 sm:overflow-y-auto sm:pr-10 gap-5 sm:gap-10">
        ...
        <Footer class="hidden sm:flex mt-auto" />
      </div>
